...
public class CustomerBL extends ClientBL {
    ...
    public void purchaseCoupon(Coupon coupon) throws CouponAmountIsZeroException, CouponDateIsExpiredException,
        ...
        // to update theCustomer after making changes in it and adjusting it to the database
        // no need to throw custom Exception because already logged in
        theCustomer = customerRepository.findById(theCustomer.getId()).orElseThrow();
    }
